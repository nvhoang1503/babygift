  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved gift as @gift" do
        ...
        post :create, {:gift => { "recipient_email" => "invalid value" }}, valid_session
        assigns(:gift).should be_a_new(Gift)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested gift" do
        ...
        Gift.any_instance.should_receive(:update_attributes).with({ "recipient_email" => "MyString" })
        put :update, {:id => gift.to_param, :gift => { "recipient_email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the gift as @gift" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Gift.any_instance.stub(:save).and_return(false)
        put :update, {:id => gift.to_param, :gift => { "recipient_email" => "invalid value" }}, valid_session
        assigns(:gift).should eq(gift)
      end
