  ...
  def plan_image_options(selected)
    [
      [Order::TYPE['1_mon'],
        ...
        <div class='info clearboth'>Billed monthly,<br> cancel anytime</div>".html_safe] ,
      [Order::TYPE['3_mon'],
        ...
        <div class='info clearboth'>Pay upfront and save,<br> renews automatically</div>".html_safe] ,
      [Order::TYPE['6_mon'],
