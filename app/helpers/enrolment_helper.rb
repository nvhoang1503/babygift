  ...
  def plan_image_options(selected)
    [
      [Order::TYPE['1_mon'],
        ...
        <div class='info clearboth'> #{I18n.t('content.page.enroll_2.text_bill_month1')} </div>".html_safe] ,
      [Order::TYPE['3_mon'],
        ...
        <div class='info clearboth'>#{I18n.t('content.page.enroll_2.text_bill_month2')}</div>".html_safe] ,
      [Order::TYPE['6_mon'],
